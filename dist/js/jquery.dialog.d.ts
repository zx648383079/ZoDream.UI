...
declare const DIALOG_SHOW = "dialog_show";
declare const DIALOG_HIDE = "dialog_hide";
declare const DIALOG_CLOSE = "dialog_close";
declare const DIALOG_CLOSING = "dialog_closing";
declare const DIALOG_LOADED = "dialog_loaded";
declare const DIALOG_ASYNC = "dialog_async";
declare const DIALOG_DONE = "dialog_done";
declare const _DIALOG_DONE = "done";
declare const _DIALOG_CANCEL = "cancel";
declare const _DIALOG_SHOW = "show";
declare const _DIALOG_HIDE = "hide";
declare const _DIALOG_CLOSE = "closed";
declare const _DIALOG_CLOSING = "closing";
